...
public class SwitchButton extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.common_SwitchButton);
        }

        shadowEffect = optBoolean(typedArray,
                R.styleable.common_SwitchButton_common_shadow_effect,
                true);

        uncheckCircleColor = optColor(typedArray,
                R.styleable.common_SwitchButton_common_uncheck_circle_color,
                0XffAAAAAA);

        uncheckCircleWidth = optPixelSize(typedArray,
                R.styleable.common_SwitchButton_common_uncheck_circle_width,
                dp2pxInt(1.5f));

        uncheckCircleOffsetX = dp2px(10);

        uncheckCircleRadius = optPixelSize(typedArray,
                R.styleable.common_SwitchButton_common_uncheck_circle_radius,
                dp2px(4));
        ...
        shadowRadius = optPixelSize(typedArray,
                R.styleable.common_SwitchButton_common_shadow_radius,
                dp2pxInt(2.5f));

        shadowOffset = optPixelSize(typedArray,
                R.styleable.common_SwitchButton_common_shadow_offset,
                dp2pxInt(1.5f));

        shadowColor = optColor(typedArray,
                R.styleable.common_SwitchButton_common_shadow_color,
                0X33000000);//0X33000000;

        uncheckColor = optColor(typedArray,
                R.styleable.common_SwitchButton_common_uncheck_color,
                0XffDDDDDD);//0XffDDDDDD;

        checkedColor = optColor(typedArray,
                R.styleable.common_SwitchButton_common_checked_color,
                0Xff51d367);//0Xff51d367;

        borderWidth = optPixelSize(typedArray,
                R.styleable.common_SwitchButton_common_sb_border_width,
                dp2pxInt(1));//dp2pxInt(1);

        checkLineColor = optColor(typedArray,
                R.styleable.common_SwitchButton_common_check_line_color,
                Color.WHITE);//Color.WHITE;

        checkLineWidth = optPixelSize(typedArray,
                R.styleable.common_SwitchButton_common_check_line_width,
                dp2pxInt(1f));//dp2pxInt(1.0f);

        checkLineLength = dp2px(6);

        int buttonColor = optColor(typedArray,
                R.styleable.common_SwitchButton_common_button_color,
                Color.WHITE);//Color.WHITE;

        uncheckButtonColor = optColor(typedArray,
                R.styleable.common_SwitchButton_common_uncheck_button_color,
                buttonColor);

        checkedButtonColor = optColor(typedArray,
                R.styleable.common_SwitchButton_common_checked_button_color,
                buttonColor);

        int effectDuration = optInt(typedArray,
                R.styleable.common_SwitchButton_common_effect_duration,
                300);//300;

        isChecked = optBoolean(typedArray,
                R.styleable.common_SwitchButton_common_checked,
                false);

        showIndicator = optBoolean(typedArray,
                R.styleable.common_SwitchButton_common_show_indicator,
                true);

        background = optColor(typedArray,
                R.styleable.common_SwitchButton_common_background,
                Color.WHITE);//Color.WHITE;

        enableEffect = optBoolean(typedArray,
                R.styleable.common_SwitchButton_common_enable_effect,
                true);
    ...
    private int optInt(TypedArray typedArray,
                       int index,
                       int def) {
        if (typedArray == null) {
            return def;
    ...
    private float optPixelSize(TypedArray typedArray,
                               int index,
                               float def) {
        if (typedArray == null) {
            return def;
    ...
    private int optPixelSize(TypedArray typedArray,
                             int index,
                             int def) {
        if (typedArray == null) {
            return def;
    ...
    private int optColor(TypedArray typedArray,
                         int index,
                         int def) {
        if (typedArray == null) {
            return def;
    ...
    private boolean optBoolean(TypedArray typedArray,
                               int index,
                               boolean def) {
        if (typedArray == null) {
            return def;
