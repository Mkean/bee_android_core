package com.bee.android.common.mmkv;

import android.text.TextUtils;

import com.bee.core.persistence.MMKVManager;
import com.bee.core.persistence.Persistence;
...
public class MMKVMultiUtils {
    ...
    public static boolean putString(String id, String key, String value) {
        Persistence sp = MMKVInstance.getPersistenceMulti(id);
     ...
     * 查询某个key是否已经存在
     *
     * @param id  区分不同业务组件的Persistence实例，相当于不同名字的Shareperfence
     * @param key
     * @return
     */
    ...
    public static String[] allkeys(String id) {
        MMKV mmkv = MMKVManager.INSTANCE.mmkvWithID_MULIT(id);
        return mmkv.allKeys();
    }
