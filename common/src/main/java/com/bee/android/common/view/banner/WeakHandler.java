...
public class WeakHandler {
    ...
    public final boolean postDelayed(Runnable r, long delayMillis) {
        return mExec.postAtTime(wrapRunnable(r), delayMillis);
    }
    ...
    public final void removeCallbacks(Runnable r, Objects token) {
        final WeakRunnable runnable = mRunnable.remove(r);
        if (runnable != null) {
    ...
    public final void removeCallbacksAndMessage(Object token) {
    ...
    public final boolean hasMessage(int what, Object object) {
    ...
    private static class ExecHandler extends Handler {
        ...
        public ExecHandler(WeakReference<Callback> mCallback) {
            this.mCallback = mCallback;
        }

        public ExecHandler(@NonNull Looper looper) {
            super(looper);
            mCallback = null;
        }

        public ExecHandler(@NonNull Looper looper, WeakReference<Callback> mCallback) {
            super(looper);
            this.mCallback = mCallback;
        }
