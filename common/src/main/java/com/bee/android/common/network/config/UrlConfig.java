...
public class UrlConfig {
    ...
    private static class Debug { // 开发环境
        static final String GCX_URL = "https://api-monkey.xueersi.com/";
        static final String H5_URL = "http://h5-test-monkey.xueersi.com/";
    ...
    private static class Release { // 线上环境
        ...
        static final String H5_URL = "https://h5.monkey.xueersi.com/";
