...
public class HomePageCourseView extends ConstraintLayout {
    ...
    private void initTabLayout(List<HomeSubjectBean> data) {
        if (tabLayout != null && data != null && data.size() > 0) {
            ...
            CommonLogger.e("首页——创建", "创建HomePageCourseView_initTabLayout_currItem==" + currentItem);
    ...
    private void intiViewPager(List<HomeSubjectBean> data) {
    ...
    private void createTitle(List<HomeSubjectBean> data) {
        if (data != null && data.size() > 0) {
            if (titles == null) {
    ...
    private void changeTabTextView(TabLayout.Tab tab, boolean big, String text) {
        if (tab != null) {
