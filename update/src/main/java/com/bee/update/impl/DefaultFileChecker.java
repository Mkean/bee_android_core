 ...
 *
 * <p>实现逻辑</p>
 * -若{@link Update#getMd5()}为空时，使用{@link PackageManager}读取apk的版本信息并与{@link Update#versionCode}对比
 * -若{@link Update#getMd5()}不为空时，则计算apk的MD5值并与{@link Update#md5}值进行对比
 * -若为在{@link #onCheckBeforeInstall()}，即下载完成后启动安装任务之前检查，当此时检查失败，则删除apk文件
 */
